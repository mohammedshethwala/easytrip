...
--
-- Dumping data for table `booking_accessories`
--

LOCK TABLES `booking_accessories` WRITE;
/*!40000 ALTER TABLE `booking_accessories` DISABLE KEYS */;
/*!40000 ALTER TABLE `booking_accessories` ENABLE KEYS */;
UNLOCK TABLES;
